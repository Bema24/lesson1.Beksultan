...
public class MainActivity<input> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_btn = findViewById(R.id.et_username);
        pass_btn = findViewById(R.id.et_password);
        car = findViewById(R.id.image);
        go = findViewById(R.id.btn_go);
        user = findViewById(R.id.inp_username);
        pass = findViewById(R.id.inp_password);
    ...
    public void sendDate()
    {
        ...
        lock = pass_btn.getText().toString().trim();
